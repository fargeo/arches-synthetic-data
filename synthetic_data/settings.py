...
DATATYPE_LOCATIONS.append('synthetic_data.datatypes')
FUNCTION_LOCATIONS.append('synthetic_data.functions')
ETL_MODULE_LOCATIONS.append('synthetic_data.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('synthetic_data.search_components')
...
SECRET_KEY = 'django-insecure-fpa#2y@7f$v_bt-t1+uln)v!4jbydn4(xybm8x3#1ax^k*6c&*'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "synthetic_data.urls"
ROOT_HOSTCONF = "synthetic_data.hosts"

DEFAULT_HOST = "synthetic_data"
...
ELASTICSEARCH_PREFIX = 'synthetic_data'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'synthetic_data.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "synthetic_data",  # Ensure the project is listed before any other arches applications
)
...
SESSION_COOKIE_NAME = 'synthetic_data'
...
# ES_MAPPING_MODIFIER_CLASSES = ["synthetic_data.search.es_mapping_modifier.EsMappingModifier"]
